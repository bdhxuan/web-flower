...
$query = "select * from chitietnd c join nguoidung t where c.id_ND = t.id_TT ";
                    ...
                    <tbody>
                        <?php foreach ($result as $key => $value1) : ?>
                            <tr>
                                ...
                                <td><a href="nv_delete_nd.php?id_ND= <?php echo $value1['id_ND'] ?>" class="btn  btn-danger" title="xoa" onclick="return confirm ('ban co muon xoa khong')">Delete</a></td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
