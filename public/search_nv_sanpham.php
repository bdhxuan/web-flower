...
$sql = "select * from sanpham s join loaihoa l on s.idLoai = l.idLoai where TenSP like '%" . $keyword . "%' or idMaSP like '%" . $keyword . "%' or TenLoai like '%" . $keyword . "%'";
            ...
            <div class="inner-wrapper row">
                <div class="col-md-12">
                    ...
                    <a href="addLoai.php" class="btn btn-success mt-2" style="margin-bottom: 30px;">
                        <i class="fa fa-plus"></i>Thêm Loại Hoa
                    </a>
