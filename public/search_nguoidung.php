...
$sql = "select * from nguoidung n join chitietnd c on n.id_TT = c.id_ND
                                    where TenND like '%" . $keyword . "%' or SDT like '%" . $keyword . "%'";
        ...
        <div class="inner-wrapper row col-md-12">
            <div class="col-md-12 mt-3">
                <nav class="navbar navbar-expand-sm navbar-dark " style="margin-bottom: 30px; float:right">
                    <form class="form-inline" method="GET" action="search_nguoidung.php">
                    ...
                    <tbody>
                        <?php while ($value1 = mysqli_fetch_array($query)) { ?>
                            <tr>
                                ...
                                <td><a href="nv_edit.php?id_ND= <?php echo $value1['id_ND'] ?>" class="btn btn-info" title="sua">Edit</a></td>
                                <td><a href="delete_nguoidung.php?idND=<?php echo $value1['id_ND'] ?> " class="btn btn-danger" title="sua">Delete</a></td>
